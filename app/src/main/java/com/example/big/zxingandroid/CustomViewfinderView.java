...
/**
 * Created by BiG on 3/10/2017 AD.
 */
...
public class CustomViewfinderView extends ViewfinderView {
  ...
  @SuppressLint("DrawAllocation") @Override public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      ...
      linearGradient =
          new LinearGradient(frame.left + 1, frame.top + laserLinePosition, frame.right - 1,
      ...
      //绘制扫描线
      canvas.drawRect(frame.left + 1, frame.top + laserLinePosition, frame.right - 1,
